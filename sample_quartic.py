...
y_traj = np.sum(np.power(x_traj,4),axis=1)

data_folder = 'data/'
filenameIpt = data_folder + 'quartic_'+ 'x_' + str(d) + '_Nsample_' + str(Nsample) +'.dat'
filenameOpt = data_folder + 'quartic_'+ 'y_' + str(d) + '_Nsample_' + str(Nsample) +'.dat'
