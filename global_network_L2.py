...
parser.add_argument('--l2reg', type=float, default=0.0001, metavar='N',
...
str_best_model =  'models/'   +   \
              ...
              '_l2reg_'   + str(args.l2reg) + '_best.h5'
...
layerHidden1     = Dense(DenseNodes, kernel_regularizer=regularizers.l2(l2reg), activation='relu', use_bias=True)(layerInput)
layerHidden2     = Dense(DenseNodes, kernel_regularizer=regularizers.l2(l2reg), activation='relu', use_bias=True)(layerHidden1)
layerOutput_pre  = Dense(1, kernel_regularizer=regularizers.l2(l2reg), activation='linear', use_bias=False)(layerHidden2)
...
log_os = open('summary_global_network_l2reg_0210.txt', "a")
log_os.write('%d\t%.3e\t' % (args.d, l2reg))
