...
from keras.layers import LocallyConnected1D, Input, Lambda
...
layerHidden1 = LocallyConnected1D(alpha, 1, strides=1, activation='relu', use_bias=True)(layerInput)
layerHidden2 = LocallyConnected1D(alpha, 1, strides=1, activation='relu', use_bias=True)(layerHidden1)
layerOutput  = LocallyConnected1D(1, 1, strides=1, activation='linear', use_bias=False)(layerHidden2)
...
log_os = open('summary_locally_connected_network_cosine_0207.txt', "a")
