...
y_traj = np.sum(np.sin(x_traj),axis=1)

data_folder = 'data/'
filenameIpt = data_folder + 'sine_'+ 'x_' + str(d) + '_Nsample_' + str(Nsample) +'.dat'
filenameOpt = data_folder + 'sine_'+ 'y_' + str(d) + '_Nsample_' + str(Nsample) +'.dat'
